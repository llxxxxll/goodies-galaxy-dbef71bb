...
export const lightingProducts: Product[] = [
  {
    ...
    details: [
      "Made of high-quality brushed aluminum with a matte finish",
      "Available in white, matte black, and brushed metal finishes",
      "Adjustable arm allows for optimal positioning",
      "Built-in LED light source with warm white illumination",
      "Touch-sensitive dimmer for brightness control",
      "Energy-efficient design with long-lasting bulb life",
      "Compact base fits easily on desks and nightstands"
    ],
    inStock: true,
    additionalImages: [
